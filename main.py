...
# Process the first sprite map
split_sprite_map(sprite_map_path_1, output_directory)
unassigned_directory_1 = os.path.join(output_directory, "unassigned")
process_unassigned_photos(unassigned_directory_1)

# Process the second sprite map
split_sprite_map(sprite_map_path_2, output_directory)
unassigned_directory_2 = os.path.join(output_directory, "unassigned")
process_unassigned_photos(unassigned_directory_2)
